package com.shafaat.apps.sms.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.shafaat.apps.sms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.shafaat.apps.sms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.shafaat.apps.sms.domain.User.class.getName());
            createCache(cm, com.shafaat.apps.sms.domain.Authority.class.getName());
